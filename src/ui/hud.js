    ...
    explorerDiv.innerHTML = `
      ...
      ">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
          <!-- Left: Settings, Dictionary & Dossier Status -->
          <div style="display: flex; align-items: center; gap: 6px;">
            ...
            <div style="display: flex; align-items: center; gap: 3px; margin-left: 2px; background: #F0F4F8; padding: 3px 6px; border-radius: 6px; border: 1px solid #D0DCE5;" title="Bureaucracy Dossier: 1.Uni 2.Lease 3.Anmeldung 4.Bank">
              <span style="font-size: 11px; opacity: ${s.isMatriculated ? '1' : '0.35'};">${s.isMatriculated ? '✅' : '📜'}</span>
              <span style="font-size: 11px; opacity: ${s.hasApartment ? '1' : '0.35'};">${s.hasApartment ? '✅' : '📄'}</span>
              <span style="font-size: 11px; opacity: ${s.hasAnmeldung ? '1' : '0.35'};">${s.hasAnmeldung ? '✅' : '📑'}</span>
              <span style="font-size: 11px; opacity: ${s.isSperrkontoUnlocked ? '1' : '0.35'};">${s.isSperrkontoUnlocked ? '✅' : '💳'}</span>
            </div>
          </div>
