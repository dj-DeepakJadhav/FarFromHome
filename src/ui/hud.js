  ...
  showCityExplorerHUD(onActionCallback) {
    ...
    explorerDiv.innerHTML = `
      ...
      <div id="city-header-bar" style="
        ...
        z-index: 100;
      ">
        <!-- Row 1: Actions, Dossier Pips, & Tuition Progress -->
        <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
          <!-- Left: Settings, Skills, Dictionary & Dossier Status -->
          <div style="display: flex; align-items: center; gap: 5px;">
            ...
            <!-- Dossier Pips: Compact inline status -->
            <div style="display: flex; align-items: center; gap: 2px; margin-left: 2px; background: #F0F4F8; padding: 2px 5px; border-radius: 6px; border: 1px solid #D0DCE5;" title="Bureaucracy Dossier: 1.Uni 2.Lease 3.Anmeldung 4.Bank">
              <span style="font-size: 10px; opacity: ${s.isMatriculated ? '1' : '0.35'};">${s.isMatriculated ? '✅' : '📜'}</span>
              <span style="font-size: 10px; opacity: ${s.hasApartment ? '1' : '0.35'};">${s.hasApartment ? '✅' : '📄'}</span>
              <span style="font-size: 10px; opacity: ${s.hasAnmeldung ? '1' : '0.35'};">${s.hasAnmeldung ? '✅' : '📑'}</span>
              <span style="font-size: 10px; opacity: ${s.isSperrkontoUnlocked ? '1' : '0.35'};">${s.isSperrkontoUnlocked ? '✅' : '💳'}</span>
            </div>
          </div>

          <!-- Right: Integrated Tuition & Visa Progress Pill -->
          <div style="display: flex; align-items: center; gap: 6px;">
            <div style="
              background: #F8F9FA;
              ...
              min-width: 75px;
            ">
              <div style="font-size: 11px; font-weight: 900; color: #E76F51; font-family: monospace;">
                ${window.FFH.round2(s.wallet)}€ <span style="font-size: 9px; color: #777; font-weight: 700;">/ ${goal}€</span>
              </div>
              <!-- Integrated Micro Progress Bar -->
              <div style="width: 100%; height: 3px; background: #E0E0E0; border-radius: 2px; margin-top: 2px; overflow: hidden;">
        ...
        ">
          <div style="display: flex; align-items: center; gap: 5px; overflow: hidden;">
            ...
            <span id="city-quest-text" style="line-height: 1.2; letter-spacing: 0.1px;">${objectiveText}</span>
          </div>
        </div>
