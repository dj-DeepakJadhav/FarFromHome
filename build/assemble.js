...
function assemble() {
  ...
  for (const vf of vendorFiles) {
    ...
    'src/data/dialogue/dialogueCivic.js',
    'src/data/dialogue/dialogueResidents.js',
    ...
    'src/render/rooms/roomDorm.js',
    'src/render/rooms/roomShops.js',
    'src/render/rooms/roomCivic.js',
    ...
    'src/render/city/cityWater.js',
    'src/render/city/cityNature.js',
    'src/render/city/cityArchitecture.js',
    ...
    'src/phases/city/cityThoughts.js',
    'src/phases/city/cityInteractions.js',
    'src/phases/city/cityCompanion.js',
    'src/phases/city/cityLetterRound.js',
