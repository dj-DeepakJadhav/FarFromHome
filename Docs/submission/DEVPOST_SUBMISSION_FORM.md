...
> **Special Award Nominations**: Most Innovative ($15K), grammatical gender as a spatial search filter · Most Satisfying Progression ($15K), €20 to €250 across five visible upgrades
...
- **Audio**: One background music track ships, inlined as a data URI so there is still zero network use. Every other sound is synthesised at runtime from oscillators, including per-character pitched talk-blips (*Animal Crossing* / *Celeste* style). There is no voice acting and no spoken German. The pick loop's anticipation cue is deliberately **visual**, so the core mechanic is fully playable muted in a noisy judging room.
...
-A genuinely satisfying progression loop: the €20 to €250 tuition meter filling alongside your 4-document dossier stamps.
