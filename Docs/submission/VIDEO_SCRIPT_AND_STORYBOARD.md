...
- **Action**: Tap Kruma Dispatch -> Meet Nina Voss -> Clock in for Shift 1.
...
- **Narration**: *"Picking is fast, tactile, and intuitive. Orders display clear English titles with German subtitles, sorted across three color-coded grammatical shelf categories: Bottom Blue for Masculine (der), Middle Pink for Feminine (die), and Top Purple for Neuter (das)."*
...
- **Action**: Courier arrives at Oma Martha's bakery doorway -> Selects polite formal greeting (*"Good morning, Frau Beck! Fresh flour and butter for your bakery!"*) -> Oma Martha beams with joy and awards a generous €12.00 tip!
