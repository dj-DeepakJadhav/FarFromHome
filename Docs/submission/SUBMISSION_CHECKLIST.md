...
- [x] **Design Intent Document**: `DESIGN_INTENT_DOC.md` — 446 words (limit 500).
      Recount: `sed '1,3d' Docs/submission/DESIGN_INTENT_DOC.md | wc -w`
- [x] **Devpost Written Questionnaire**: `DEVPOST_SUBMISSION_FORM.md` pre-filled.
...
- [x] **Focus (15%)**: one cohesive narrative-courier sim; documentation consolidated
      so no out-of-scope system is advertised to judges.
...
- *Most Satisfying Progression ($15K)*: €20 ➔ €250 curve with 5 upgrades
  (see [`../CANONICAL_NUMBERS.md`](../CANONICAL_NUMBERS.md) §3).
