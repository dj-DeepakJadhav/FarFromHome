...
| **14** | [**Emergence, Dynamic Narrative and Systems**](https://www.youtube.com/watch?v=OrmyLaLCaIo) | The Game Overanalyser | • **Dynamic Complexity Theory in Games**: How simple interacting rules (friction + stamina + cash risk + social reputation) yield infinitely varied player journeys.<br>• **Feedback Loops**: Positive reinforcement (high accuracy ➔ higher tips ➔ bike upgrade ➔ easier drift) balanced by negative constraints (20h legal cap). | Provides mathematical elegance to the student economy and narrative loop. |
