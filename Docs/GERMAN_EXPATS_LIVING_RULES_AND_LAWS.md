...
> **Master Authority Document for *Far From Home: Kruma Express***  
> Every game design system, narrative branch, character dialogue, and code mechanic MUST strictly align with the real-world laws and cultural realities documented here.
...
```mermaid
graph TD
    classDef law fill:#1D3557,stroke:#264653,stroke-width:2px,color:#fff;
    classDef doc fill:#2A9D8F,stroke:#264653,stroke-width:2px,color:#fff;
    classDef lock fill:#E76F51,stroke:#264653,stroke-width:2px,color:#fff;

    Hostel([Arrival in Germany: 28-Day Tourist/Entry Visa]) --> Lease[1. WG Rental Contract + Wohnungsgeberbestätigung from Landlord]:::doc
    Lease --> Anmeldung[2. Anmeldung at Bürgeramt / Rathaus: Meldebescheinigung]:::doc
    Anmeldung --> TaxID[3. Automatic Issue of Tax ID: Steuer-ID from Bundeszentralamt]:::doc
    Anmeldung --> Bank[4. Girokonto & Blocked Account Sperrkonto Activation at Sparkasse]:::doc
    Bank --> HealthIns[5. Statutory Student Health Insurance: TK / AOK 125€/mo]:::doc
    HealthIns --> Matriculation[6. University Immatrikulation: Pay 250€ Semesterbeitrag]:::doc
    Matriculation --> SemTicket[7. Semesterticket: Free Regional Bus & Train Transit]:::doc
    Matriculation --> WorkContract[8. Legal Primary Employment: Werkstudent / Minijob Contract]:::doc
    WorkContract --> FinalVisa[9. Ausländerbehörde: Official 2-Year Aufenthaltstitel Residence Permit]:::law
```
...
1. **Tax Identification Number (*Steuer-ID*)**:
   - An 11-digit lifelong number issued automatically by the *Bundeszentralamt für Steuern* 2–3 weeks after *Anmeldung*. Without it, employers must deduct maximum emergency tax under **Tax Class VI (Steuerklasse 6)** (up to 45%+ withheld!).
2. **Tax Classes**:
...
3. **Stoßlüften (Shock Ventilation Obligation)**:
   - Opening windows completely wide for **5 to 10 minutes, 2–3 times a day** (*Stoßlüften / Querlüften*) to exchange stale humid indoor air with dry outdoor air. German leases explicitly obligate tenants to do this to prevent structural mold (*Schimmelbildung*).
